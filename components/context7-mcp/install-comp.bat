...
rem ================================================================
rem Script:  install-comp.bat (Context7 MCP)
rem Purpose: Install a Context7 MCP server via npm.
...
set "OUT_FILE=%TEMP%\lanren-context7-mcp-install-%LOG_ID%.log"

net session >nul 2>&1
if %errorlevel% neq 0 (
    echo Requesting administrative privileges to install Context7 MCP server...
