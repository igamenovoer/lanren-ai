...
rem ================================================================
rem Script:  install-comp.bat (Claude Code CLI)
rem Purpose: Install the Claude Code CLI and configure it to skip onboarding.
...
set "OUT_FILE=%TEMP%\lanren-claude-code-cli-install-%LOG_ID%.log"

net session >nul 2>&1
if %errorlevel% neq 0 (
    echo Requesting administrative privileges to install Claude Code CLI...
