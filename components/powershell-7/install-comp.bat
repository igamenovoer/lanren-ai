...
rem ================================================================
rem Script:  install-comp.bat (PowerShell 7)
rem Purpose: Install PowerShell 7 on Windows.
...
set "OUT_FILE=%TEMP%\lanren-powershell7-install-%LOG_ID%.log"

net session >nul 2>&1
if %errorlevel% neq 0 (
    echo Requesting administrative privileges to install PowerShell 7...
