...
rem ================================================================
rem Script:  install-comp.bat (Git)
rem Purpose: Install Git for Windows, preferring winget.
...
set "OUT_FILE=%TEMP%\lanren-git-install-%LOG_ID%.log"

net session >nul 2>&1
if %errorlevel% neq 0 (
    echo Requesting administrative privileges to install Git...
