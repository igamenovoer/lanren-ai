...
rem ================================================================
rem Script:  install-comp.bat (OpenAI Codex CLI)
rem Purpose: Install the OpenAI Codex CLI via npm.
...
set "OUT_FILE=%TEMP%\lanren-codex-cli-install-%LOG_ID%.log"

net session >nul 2>&1
if %errorlevel% neq 0 (
    echo Requesting administrative privileges to install Codex CLI...
