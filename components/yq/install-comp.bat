...
rem ================================================================
rem Script:  install-comp.bat (yq)
rem Purpose: Install yq on Windows, preferring winget.
...
set "OUT_FILE=%TEMP%\lanren-yq-install-%LOG_ID%.log"

net session >nul 2>&1
if %errorlevel% neq 0 (
    echo Requesting administrative privileges to install yq...
