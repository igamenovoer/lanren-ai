...
rem ================================================================
rem Script:  install-comp.bat (winget)
rem Purpose: Ensure winget is available by installing App Installer.
...
set "OUT_FILE=%TEMP%\lanren-winget-install-%LOG_ID%.log"

net session >nul 2>&1
if %errorlevel% neq 0 (
    echo Requesting administrative privileges to ensure winget is installed...
