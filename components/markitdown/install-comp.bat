...
rem ================================================================
rem Script:  install-comp.bat (MarkItDown)
rem Purpose: Install MarkItDown via uv tool.
...
set "OUT_FILE=%TEMP%\lanren-markitdown-install-%LOG_ID%.log"

net session >nul 2>&1
if %errorlevel% neq 0 (
    echo Requesting administrative privileges to install MarkItDown...
