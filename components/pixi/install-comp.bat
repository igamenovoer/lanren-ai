...
rem ================================================================
rem Script:  install-comp.bat (pixi)
rem Purpose: Install pixi on Windows, preferring winget.
...
set "OUT_FILE=%TEMP%\lanren-pixi-install-%LOG_ID%.log"

net session >nul 2>&1
if %errorlevel% neq 0 (
    echo Requesting administrative privileges to install pixi...
